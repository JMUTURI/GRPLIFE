...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2149, 27, 'MONTHLY_CONTRIBUTION_SUMMARY', 'Pension monthly contribution summary', 'pens_monthly_contri_sum.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3486, 2149, 'pens_monthly_contri_sum_temp.rtf', 'MONTHLY_CONTRIBUTION_SUMMARY', 'Pension monthly  contribution template', 
    'pens_monthly_contri_sum_temp.xsl', NULL, 'A');
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25050, 2149, 'UP_DATE_FROM', 'Date From', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25051, 2149, 'UP_DATE_TO', 'Date To', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
