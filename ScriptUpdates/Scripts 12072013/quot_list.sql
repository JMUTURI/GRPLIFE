...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2145, 27, 'QUOTATION_LIST_REPORT', 'Quotation list schedule', 'quot_list.xml', 
    NULL, 'A');
...
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3480, 2145, 'quot_list_temp.rtf', 'QUOTATION_LIST_RPT', 'Quotation list Template', 
    'quot_list_temp.xsl', NULL, 'A');
...
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25044, 2145, 'V_DATE_FROM', 'QUOTATION DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25045, 2145, 'V_DATE_TO', 'QUOTATION DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
