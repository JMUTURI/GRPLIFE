...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2144, 27, 'TRUST_DEED_PENS', 'Trust deed pensions', 'trust_deed_pens.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3479, 2144, 'trust_deed_pens_temp.rtf', 'TRUST_DEED_PENS', 'Trust deed pens template', 
    'trust_deed_pens_temp.xsl', NULL, 'A');
COMMIT;
END;
/