...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2016, 27, 'GL_VAL_REPORT', 'Group Life Valuation Report', 'glvalrpt.xml', 
    NULL, 'A');
COMMIT;
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3343, 2016, 'glvalrpt_temp.rtf', 'GL_VAL_REPORT', 'Group Life Valuation Report Template', 
    'glvalrpt_temp.xsl', NULL, 'A');
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (24774, 2016, 'GRP_TRANS_TYPE', 'Group Life Transactions', 'Group Life Transactions', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (24772, 2016, 'V_DATE_FROM', 'DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (24773, 2016, 'V_DATE_TO', 'DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
end;
