...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2200, 27, 'FUND_MANAGEMENT_RPT', 'Fund management report', 'fund_management.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3540, 2200, 'fund_management_temp.rtf', 'FUND_MANAGEMENT_RPT', 'Fund management report', 
    'fund_management_temp.xsl', NULL, 'A'); 
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25101, 2200, 'V_DATE_FROM', 'DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25102, 2200, 'V_DATE_TO', 'DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
