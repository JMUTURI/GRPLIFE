...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2201, 27, 'INVESTMENT_POL_STATEMENT', 'Investment Policy Statement', 'inv_pol_stat.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3541, 2201, 'inv_pol_stat_temp.rtf', 'INVESTMENT_POL_STATEMENT', 'Investment Policy Statement', 
    'inv_pol_stat_temp.xsl', NULL, 'A');
commit;
end;
/