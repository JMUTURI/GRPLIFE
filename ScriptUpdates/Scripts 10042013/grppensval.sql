...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2017, 27, 'PENS_VAL_RPT', 'Pension Valuation Report', 'grppensval.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3344, 2017, 'grppensval_temp.rtf', 'PENS_VAL_RPT', 'Pension Valuation Report template', 
    'grppensval_temp_temp.xsl', NULL, 'A');
COMMIT;
END;
/
...
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (24801, 2017, 'END_DATE', 'END DATE', 'End Date', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (24800, 2017, 'START_DATE', 'START DATE', 'Start Date', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
