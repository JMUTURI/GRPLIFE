...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2169, 27, 'RIDER_CLAIMS_REPORT', 'Rider claims reports', 'clm_rider_summ.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3507, 2169, 'clm_rider_summ_temp.rtf', 'RIDER_CLAIMS_REPORT', 'Rider claims reports Template', 
    'clm_rider_summ_temp.xsl', NULL, 'A');
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25078, 2169, 'V_DATE_FROM', 'DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25079, 2169, 'V_DATE_TO', 'DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
