...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2219, 27, 'CONTRIBUTION_STATEMENT', 'Contribution Statement Report', 'contri_stat.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3560, 2219, 'contri_stat_temp.rtf', 'CONTRIBUTION_STATEMENT', 'Contribution Statement Template', 
    'contri_stat_temp.xsl', NULL, 'A');
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25119, 2219, 'V_DATE_FROM', 'DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25120, 2219, 'V_DATE_TO', 'DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');   
