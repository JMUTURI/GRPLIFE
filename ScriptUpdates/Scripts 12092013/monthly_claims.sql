...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2291, 27, 'MONTHLY_SUMMARY_RPT', 'Monthly Claims Summary', 'monthly_claims.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3628, 2291, 'monthly_claims_temp.rtf', 'MONTHLY_SUMMARY_RPT', 'Monthly Claims Summary Template', 
    'monthly_claims_temp.xsl', NULL, 'A');
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25223, 2291, 'V_DATE_FROM', 'DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25224, 2291, 'V_DATE_TO', 'DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
