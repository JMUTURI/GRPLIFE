...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2253, 27, 'UNDERWRITING_WORKSHEET', 'Underwriting worksheet', 'underwiting_worksheet.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3594, 2253, 'underwiting_worksheet_temp.rtf', 'UNDERWRITING_WORKSHEET', 'Underwriting worksheet Template', 
    'underwiting_worksheet_temp.xsl', NULL, 'A');
COMMIT;
END;
/