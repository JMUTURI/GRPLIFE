...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (1863, 27, 'PROD_PMYT_OUT_RPT', 'Production Payment Outstanding Report', 'ProdPmytOut.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3186, 1863, 'ProdPmytOut_temp.rtf', 'PROD_PMYT_OUT_RPT', 'Production Payment Outstanding Report', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE)
 Values
   (24457, 1863, 'START_DATE', 'START_DATE', 'Start Date', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE)
 Values
   (24458,1863, 'END_DATE', 'END_DATE', 'End Date', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL);
COMMIT;
end;
