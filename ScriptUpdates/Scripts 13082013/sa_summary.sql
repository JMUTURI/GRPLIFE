...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2237, 27, 'SA_SUMMARY_RPT', 'Sum assured summary', 'sa_summary.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3580, 2237, 'sa_summary_temp.rtf', 'SA_SUMMARY_RPT', 'Sum assured report Template', 
    'sa_summary_temp.xsl', NULL, 'A');
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25138, 2237, 'V_DATE_FROM', 'DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25139, 2237, 'V_DATE_TO', 'DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');    
COMMIT;
end;
