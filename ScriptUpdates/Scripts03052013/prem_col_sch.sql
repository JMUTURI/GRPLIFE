...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2037, 27, 'PREM_INCOME_SCH', 'Premium Income Schedule', 'prem_income_sch.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3362, 2037, 'prem_income_sch_temp.rtf', 'PREM_INCOME_SCH_RPT', 'Premium Income Schedule', 
    'prem_income_sch_temp.xsl', NULL, 'A');
 ...
 Values
   (24820, 2037, 'UP_DATE_FROM', 'START DATE', 'Start Date', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (24821, 2037, 'UP_DATE_TO', 'END DATE', 'End Date', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
