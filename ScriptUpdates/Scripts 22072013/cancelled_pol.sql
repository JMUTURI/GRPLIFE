...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2166, 27, 'CANCELLED_POLICIES_RPT', 'Cancelled policies report', 'cancelled_pol.xml', 
    NULL, 'A');
...
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3504, 2166, 'cancelled_pol_temp.rtf', 'CANCELLED_POLICIES_RPT', 'Cancelled policies  Template', 
    'cancelled_pol_temp.xsl', NULL, 'A');
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25073, 2166, 'V_DATE_FROM', 'DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25074, 2166, 'V_DATE_TO', 'DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
