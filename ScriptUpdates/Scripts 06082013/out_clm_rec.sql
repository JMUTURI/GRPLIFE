...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2213, 27, 'OUTSTANDING_CLAIMS_RECOVERY', 'Outstanding claims recovery', 'out_clm_rec.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3553, 2213, 'out_clm_rec_temp.rtf', 'OUTSTANDING_CLAIMS_RECOVERY', 'Outstanding claims recovery', 
    'out_clm_rec_temp.xsl', NULL, 'A');
 ...
 Values
   (25117, 2213, 'UP_DATE_FROM', 'START DATE', 'Start Date', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25118, 2213, 'UP_DATE_TO', 'END DATE', 'End Date', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
