...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2133, 27, 'ACCEPTANCE_FORM', 'Acceptance Form', 'acceptancelet.xml', 
    NULL, 'A');
SET DEFINE OFF;
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3467, 2133, 'acceptancelet_temp.rtf', 'ACCEPTANCE_FORM_RPT', 'Acceptance Form', 
    'acceptancelet_temp.xsl', NULL, 'A');
COMMIT;
END;
/