...
Insert into TQC_SYSTEM_REPORTS
 ...
 Values
   (2235, 27, 'REIN_PREM_RPT', 'Reinsurance premium report', 'rein_prem_rpt.xml', 
    NULL, 'A');
Insert into TQC_SYS_RPT_TEMPLATES
 ...
 Values
   (3578, 2235, 'rein_prem_rpt_temp.rtf', 'REIN_PREM_RPT', 'Reinsurance premium report Template', 
    'rein_prem_rpt_temp.xsl', NULL, 'A');
Insert into TQC_SYS_RPT_PARAMETERS
 ...
 Values
   (25134, 2235, 'V_DATE_FROM', 'DATE FROM', 'Date From', 
...
Insert into TQC_SYS_RPT_PARAMETERS
   (RPTP_CODE, RPTP_RPT_CODE, RPTP_PARAM_NAME, RPTP_PARAM_DESC, RPTP_PARAM_PROMPT, 
    ...
    RPTP_CHILD_CODE, RPTP_PARAM_ACTIVE)
 Values
   (25135, 2235, 'V_DATE_TO', 'DATE TO', 'Date To', 
    'DATE', NULL, NULL, NULL, NULL, 
    NULL, 'A');
COMMIT;
END;
