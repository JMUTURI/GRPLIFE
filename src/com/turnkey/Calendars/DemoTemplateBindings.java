...
public class DemoTemplateBindings {
    ...
    private boolean _isEditing(UIComponent comp, UIComponent altComp,
                               String attrName) {
        if (comp == null) {
            return false;
        }
      ...
      if (template != null)
      {
        ...
        if (val != null)
        {
          ...
          attrs.put(attrName, val);
            ...
            val =
(Boolean)facesContext.getApplication().evaluateExpressionGet(facesContext,
                                                             "#{attrs." +
                                                             attrName + "}",
                                                             Boolean.class);
            if (val != null) {
    ...
    private void _checkViewRoot() {
        ...
        if (_documentComponent != null) {
            UUID docId =
                (UUID)_documentComponent.getAttributes().get(_UUID_ATTRIBUTE_KEY);
            if (docId == null) {
                _documentComponent.getAttributes().put(_UUID_ATTRIBUTE_KEY,
                                                       uuid);
        ...
        if (_formComponent != null) {
            UUID formId =
                (UUID)_formComponent.getAttributes().get(_UUID_ATTRIBUTE_KEY);
            if (formId == null) {
    ...
    private final static String _UUID_ATTRIBUTE_KEY =
        DemoTemplateBindings.class.getName() + "_UUID";
}
