 ...
 * </ul>
 */
public class DemoCalendarArabicModelBean extends DemoCalendarModelBean {
    ...
    protected String getAllDayActivityTitle(String titleAddition, long numDays,
        ...
        if (numDays > 1) {
            ...
            title =
                    title + " \u0648 \u0648 \u0648 \u0648 \u0648 \u0648 " + DateFormat.getDateInstance(DateFormat.SHORT,
                                                                                                       _araLocale).format(endCalendar.getTime());
            endCalendar.add(Calendar.DAY_OF_YEAR, 1);
        ...
        if (c1DayOfYear != c2DayOfYear || c1Year != c2Year) {
            DateFormat formatter =
                DateFormat.getDateTimeInstance(DateFormat.SHORT,
                                               DateFormat.SHORT, _araLocale);
            title =
                    title + " \u0642 \u0642 \u0642 \u0642 \u0642 " + formatter.format(endCalendar.getTime()) +
                    " " +
