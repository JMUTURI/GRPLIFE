...
public class DemoSingleProviderCalendarModel extends CalendarModel {
    ...
    public synchronized List<CalendarActivity> getTimeActivities(Date rangeStart,
        ...
        if (getProvider().getEnabled().equals(CalendarProvider.Enabled.ENABLED)) {
            List<CalendarActivity> allTimeActivities =
                _getTimeActivitiesFromAll();
            return _getActivities(allTimeActivities, rangeStart, rangeEnd,
                                  timeZone);
        }
    ...
    public synchronized List<CalendarActivity> getAllDayActivities(Date rangeStart,
                                                                   ...
                                                                   TimeZone timeZone) {
        if (getProvider().getEnabled().equals(CalendarProvider.Enabled.ENABLED)) {
            List<CalendarActivity> allAlldayActivities =
                _getAllDayActivitiesFromAll();
            return _getActivities(allAlldayActivities, rangeStart, rangeEnd,
                                  timeZone);
        }
