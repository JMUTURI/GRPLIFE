...
public class GetTransactionList  implements java.io.Serializable {
    ...
    /**
     * Gets the hostName value for this GetTransactionList.
     * 
     * @return hostName
     */
    ...
    /**
     * Sets the hostName value for this GetTransactionList.
     * 
     * @param hostName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://endpoint.payment.projects.leadway.com/", "getTransactionList"));
