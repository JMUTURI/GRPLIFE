...
public class pensionsManipulation
{
    ...
    public String CmdNext()
  {
    ...
    try
    {
      ...
      String polQuery = "begin LMS_WEB_PKG_GRP_UW.createtransaction(?,?,?);end;";
      ...
      this.session.setAttribute("transactionNumber", cst.getBigDecimal(1));
      this.session.setAttribute("pensTransType", this.transType.getValue().toString());
  ...
  public String ValidateUserRights()
  {
    ...
    try
    {
      ...
      String query = "begin ?:= TQC_INTERFACES_PKG.check_user_rights(?,?,?,?,?); end;";
  ...
  {
    DCIteratorBinding dciter = ADFUtils.findIterator("findProductsByTypeIterator");
  ...
  {
    DCIteratorBinding dciter = ADFUtils.findIterator("FindPensionTransactionsIterator");
  ...
  {
    DCIteratorBinding dciter = ADFUtils.findIterator("FindDeductionsIterator");
  ...
  {
    DCIteratorBinding dciter = ADFUtils.findIterator("FindPensionBalancesSummaryIterator");
    ...
    while (rowKeySetIter.hasNext())
    {
      ...
      this.session.setAttribute("ValuationPeriod", r.getAttribute("PNBAL_PERIOD"));
  ...
  {
    DCIteratorBinding dciter = ADFUtils.findIterator("FindPensionBalancesPeriodsIterator");
    ...
    while (rowKeySetIter.hasNext())
    {
      ...
      this.session.setAttribute("UWYear", r.getAttribute("PNBAL_YEAR"));
      this.session.setAttribute("pnbalpCode", r.getAttribute("PNBALP_CODE"));
      

      this.prdWEF.setValue(r.getAttribute("PNBALP_WEF"));
      this.prdWET.setValue(r.getAttribute("PNBALP_WET"));
      this.session.setAttribute("WEFDate", GlobalCC.upDateParseDate(this.prdWEF.getValue().toString()));
      
      this.session.setAttribute("WETDate", GlobalCC.upDateParseDate(this.prdWET.getValue().toString()));
  ...
  public String AddPeriodicValuation()
  {
    ...
    erkService.addScript(FacesContext.getCurrentInstance(), "var hints = {autodismissNever:false}; AdfPage.PAGE.findComponent('lmsgroup:periodicVal').show(hints);");
  ...
  public String EditPeriodicValuation()
  {
    try
    {
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        if ((Authorised.equalsIgnoreCase("Authorised")) && (revaluedStatus.equalsIgnoreCase("N")))
        {
        ...
        this.session.setAttribute("lpnt_code", r.getAttribute("PNBALP_LPNT_CODE"));
  ...
  public String DeletePeriodicValuation()
  {
    try
    {
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        Authorised = (String)r.getAttribute("STATUS");
        if ((Authorised.equalsIgnoreCase("Authorised")) && (getRevaluedStatus().equals("N")))
        {
          GlobalCC.sysInformation("You cannot make changes to an Authorised Valuation");
          return null;
        }
  ...
  public String ReEvaluateYear()
  {
    ...
    try
    {
      String Query = "BEGIN LMS_WEB_PKG_GRP_UW.ReEvaluatePensionYear(?,?);END;";
  ...
  public String getRevaluedStatus()
  {
    ...
    try
    {
      String Query = "begin ? := LMS_WEB_PKG_GRP_UW.get_pens_rev_status(?,?); end;";
    ...
    try
    {
      ...
      if (Act != "D")
      {
        ...
        if (this.prdWEF.getValue().toString().contains(":")) {
          prdWEFString = GlobalCC.parseDate(this.prdWEF.getValue().toString());
        } else {
          prdWEFString = GlobalCC.upDateParseDate(this.prdWEF.getValue().toString());
        }
        if (this.prdWET.getValue().toString().contains(":")) {
          prdWETString = GlobalCC.parseDate(this.prdWET.getValue().toString());
        } else {
          prdWETString = GlobalCC.upDateParseDate(this.prdWET.getValue().toString());
        }
      }
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_UW.updatepensionbalancePeriods(?,?,?,?,?,?,?,?,?);END;";
      ...
      cstmt.setBigDecimal(2, (BigDecimal)this.session.getAttribute("pnbalpCode"));
      ...
      cstmt.setBigDecimal(8, (BigDecimal)this.session.getAttribute("lpnt_code"));
  ...
  public String RateTableSelected()
  {
    try
    {
      ...
      JUCtrlValueBinding r = (JUCtrlValueBinding)this.rateTables.getRowData();
      if (r == null) {
        GlobalCC.errorValueNotEntered("Error: No Record Selected");
      }
      this.tablesDesc.setValue(r.getAttribute("LPNT_DESC"));
      this.session.setAttribute("lpnt_code", r.getAttribute("LPNT_CODE"));
  ...
  public String editPensionBalancesSel()
  {
    try
    {
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        {
          String messages = "You cannot make changes to an Authorised Valuation";
          
          FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, messages, messages));
      ...
      erkService.addScript(FacesContext.getCurrentInstance(), "var hints = {autodismissNever:false}; AdfPage.PAGE.findComponent('lmsgroup:valuation').show(hints);");
    }
    catch (Exception e)
    {
      GlobalCC.EXCEPTIONREPORTING(null, e);
  ...
  public String editDeductions()
  {
    try
    {
      DCIteratorBinding dciter = ADFUtils.findIterator("FindPensionDeductionsIterator");
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        this.session.setAttribute("pdedCode", r.getAttribute("SEL_PDED_CODE"));
      }
      ExtendedRenderKitService erkService = (ExtendedRenderKitService)Service.getService(FacesContext.getCurrentInstance().getRenderKit(), ExtendedRenderKitService.class);
      

      erkService.addScript(FacesContext.getCurrentInstance(), "var hints = {autodismissNever:false}; AdfPage.PAGE.findComponent('lmsgroup:deduction').show(hints);");
    }
    catch (Exception e)
    {
      GlobalCC.EXCEPTIONREPORTING(null, e);
  ...
  public String DeleteDeductions()
  {
    ...
    try
    {
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        String populateTaxes = "BEGIN LMS_WEB_PKG_GRP.deletedeductions(?);END;";
  ...
  public String SavePensionBalances()
  {
    ...
    try
    {
      ...
      if (this.edValDate.getValue().toString().contains(":")) {
        todayString = GlobalCC.parseDate(this.edValDate.getValue().toString());
      } else {
        todayString = GlobalCC.upDateParseDate(this.edValDate.getValue().toString());
      }
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_UW.updatePensionBalances(?,?,?,?,?);END;";
      ...
      cstmt.setString(5, (String)this.session.getAttribute("ValuationPeriod"));
  ...
  public String ProcessPensionBalances()
  {
    ...
    try
    {
      ...
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_UW.process_annual_valuation(?,?,?,?,?);END;";
  ...
  public String ProcessPeriodBalances()
  {
    ...
    try
    {
      ...
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_UW.process_periodic_valuation(?,?);END;";
  ...
  public String AuthorisePensionBalances()
  {
    ...
    try
    {
      ...
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_UW.auth_annual_valuation(?,?,?,?);END;";
  ...
  public String AuthorisePeriodPensionBalances()
  {
    ...
    try
    {
      ...
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_UW.auth_periodic_valuation(?,?,?);END;";
  ...
  public String SaveDeductions()
  {
    ...
    if ((!this.session.getAttribute("taxType").equals("SRG")) && 
      (this.dedTaxAmt.getValue() == null) && (this.dedRate.getValue() == null))
    {
    ...
    if ((RateAmount.equalsIgnoreCase("R")) && (Amt.equalsIgnoreCase("Y")))
    {
      GlobalCC.INFORMATIONREPORTING("You have selected Rate. You cannot Input an Amount. " + this.dedTaxAmt.getValue().toString());
      
      return null;
    }
    if ((RateAmount.equalsIgnoreCase("A")) && (Rate.equalsIgnoreCase("Y")))
    {
    ...
    try
    {
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP.updatepensiondeductions(?,?,?,?,?,?,?,?,?,?,?);END;";
      

      conn = new DBConnector().getDatabaseConn();
      
      CallableStatement cstmt = conn.prepareCall(populateTaxes);
      cstmt.setBigDecimal(1, (BigDecimal)this.session.getAttribute("pdedCode"));
      
      cstmt.setBigDecimal(2, (BigDecimal)this.session.getAttribute("policyCode"));
      
      cstmt.setBigDecimal(3, (BigDecimal)this.session.getAttribute("ttCode"));
      ...
      if (this.dedDate.getValue().toString().contains(":")) {
        cstmt.setString(6, GlobalCC.parseDate(this.dedDate.getValue().toString()));
      } else {
        cstmt.setString(6, GlobalCC.upDateParseDate(this.dedDate.getValue().toString()));
      }
      ...
      if (this.deductRateOrAmt.getValue() == null) {
        ...
        cstmt.setString(11, this.deductRateOrAmt.getValue().toString());
      }
      cstmt.execute();
      conn.close();
  ...
  public String PopulatePolicyDeductions()
  {
    ...
    try
    {
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP.populate_pensiondeductions(?,?);END;";
  ...
  public String ComputeDeductions()
  {
    ...
    try
    {
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP.computedeductions(?);END;";
  ...
  public String AuthoriseDeductions()
  {
    ...
    try
    {
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP.authorizedeductions(?,?);END;";
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        cstmt.setBigDecimal(2, (BigDecimal)r.getAttribute("SEL_PDED_CODE"));
  ...
  public String AddWithdrawalAmount()
  {
    ...
    erkService.addScript(FacesContext.getCurrentInstance(), "var hints = {autodismissNever:false}; AdfPage.PAGE.findComponent('lmsgroup:pensionsDepositsPopup').show(hints);");
  ...
  {
    DCIteratorBinding dciter = ADFUtils.findIterator("FindPensionDepositsIterator");
    ...
    while (rowKeySetIter.hasNext())
    {
      ...
      this.session.setAttribute("withdrawalReceipt", r.getAttribute("PNDP_GRCT_CODE"));
    }
    ExtendedRenderKitService erkService = (ExtendedRenderKitService)Service.getService(FacesContext.getCurrentInstance().getRenderKit(), ExtendedRenderKitService.class);
  ...
  public String DeletePensWithdrawal()
  {
    ...
    String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_PENS.deletePensionDeposit(?);END;";
  ...
  public String SaveWithdrawalAmount()
  {
    ...
    try
    {
      ...
      String polQuery = "begin LMS_WEB_PKG_GRP_PENS.createPensionDeposits(?,?,?,?,?,?,?,?,?,?,?);end;";
      ...
      cst.setBigDecimal(3, (BigDecimal)this.session.getAttribute("withdrawalReceipt"));
      ...
      if (this.withDate.getValue().toString().contains(":")) {
        cst.setString(5, GlobalCC.parseDate(this.withDate.getValue().toString()));
      } else {
        cst.setString(5, GlobalCC.upDateParseDate(this.withDate.getValue().toString()));
      }
      cst.setBigDecimal(6, (BigDecimal)this.session.getAttribute("PNDP_CODE"));
      ...
      cst.setBigDecimal(10, (BigDecimal)this.session.getAttribute("client_bank_code"));
  ...
  public String ComputeWithAmount()
  {
    ...
    try
    {
      ...
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_PENS.computePensWithdrawal(?,?);END;";
  ...
  public String AuthoriseWithdrawal()
  {
    ...
    try
    {
      ...
      String populateTaxes = "BEGIN LMS_WEB_PKG_GRP_PENS.authorisePensWithdrawal(?,?,?,?);END;";
  ...
  public String DistributeToMembers()
  {
    ...
    while (rowKeySetIter.hasNext())
    {
      ...
      Row r = dciter.getCurrentRow();
      this.session.setAttribute("PNDP_CODE", r.getAttribute("PNDP_CODE"));
      this.session.setAttribute("GrctCode", r.getAttribute("PNDP_GRCT_CODE"));
  ...
  public String ProcessWithdrawal()
  {
    ...
    try
    {
      Integer Value = (Integer)this.session.getAttribute("receiptTemplateSeq");
      if (Value.intValue() == 0)
      {
  ...
  public String selectBank()
  {
    try
    {
      DCIteratorBinding dciter = ADFUtils.findIterator("FindClientBankDetailsIterator");
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        dciter.setCurrentRowWithKey(key.toStringFormat(true));
        Row r = dciter.getCurrentRow();
        this.session.setAttribute("client_bank_code", r.getAttribute("BBR_CODE"));
        
        this.bankNameTF.setValue(r.getAttribute("BBR_BRANCH_NAME"));
        System.out.println("Branch Name" + r.getAttribute("BBR_BRANCH_NAME"));
    ...
    catch (Exception e)
    {
      e = 
        ...
        e;GlobalCC.EXCEPTIONREPORTING(null, e);
    }
    finally {}
    return null;
  }
  ...
  public String authRefund()
  {
    ...
    {
      conn = new DBConnector().getDatabaseConn();
      String authQuery = "BEGIN LMS_WEB_PKG_GRP.Authorise_Revaluation_Refund(?,?,?);END;";
      
      CallableStatement cstmt = conn.prepareCall(authQuery);
      DCIteratorBinding dciter = ADFUtils.findIterator("valuation_refundsIterator");
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        cstmt.setBigDecimal(2, (BigDecimal)r.getAttribute("PPV_VOUCHER_NO"));
    ...
    catch (Exception e)
    {
      e = 
        ...
        e;GlobalCC.EXCEPTIONREPORTING(conn, e);e.printStackTrace();
    }
    finally {}
    return null;
  }
  ...
  public String reverseDeduction()
  {
    ...
    {
      conn = new DBConnector().getDatabaseConn();
      String authQuery = "BEGIN LMS_WEB_PKG_GRP.reversedeductions(?,?);END;";
      
      CallableStatement cstmt = conn.prepareCall(authQuery);
      DCIteratorBinding dciter = ADFUtils.findIterator("AuthorisedPensionDeductionsIterator");
      ...
      while (rowKeySetIter.hasNext())
      {
        ...
        dciter.setCurrentRowWithKey(key.toStringFormat(true));
        Row r = dciter.getCurrentRow();
        cstmt.setBigDecimal(1, (BigDecimal)r.getAttribute("AUTH_SEL_PDED_CODE"));
        
        cstmt.setString(2, (String)this.session.getAttribute("Username"));
      }
      cstmt.execute();
      cstmt.close();
      conn.close();
  ...
  public RichSelectOneChoice getDeductEstOrAct()
  {
    ...
    public String searchBankDetails() {
        if(bankDetailsTF.getValue()!=null){
            session.setAttribute("BankSearchString", bankDetailsTF.getValue().toString());
        }
