...
public class Claim {
    ...
    private BigDecimal GPW_CODE;
    private BigDecimal GPW_EMPYR_BAL_BF;
    private BigDecimal GPW_EMPYR_AMT;
    private BigDecimal GPW_EMPYR_INT;
    private BigDecimal GPW_EMPYR_CF;
    private BigDecimal GPW_EMPYR_WITHDRAWABLE_AMT;
    private BigDecimal GPW_EMPYE_BAL_BF;
    private BigDecimal GPW_EMPYE_AMT;
    private BigDecimal GPW_EMPYE_INT;
    private BigDecimal GPW_EMPYE_CF;
    private BigDecimal GPW_EMPYE_WITHDRAWABLE_AMT;
    private BigDecimal TOTAL_BAL_BF;
    private BigDecimal TOTAL_AMOUNT;
    private BigDecimal TOTAL_INT;
    private BigDecimal TOTAL_BAL_CF;
    private BigDecimal TOTAL_WITHDRAWABLE_AMT;
    private String GPW_WITH_APPLIED_ON;
    private BigDecimal GPW_TAX_EXEMP_AMT;
    private BigDecimal GPW_AMT_APPLIED;
    private BigDecimal GPW_YRS_OF_SERV;
    private BigDecimal GPW_TAX_AMOUNT;
    private BigDecimal GPW_OVERRIDE_TAX_AMT;
    private BigDecimal GPW_EMPYE_REG_WITH_AMT;
    private BigDecimal GPW_EMPYE_UNREG_WITH_AMT;
    private BigDecimal GPW_EMPYR_REG_WITH_AMT;
    private BigDecimal GPW_EMPYR_UNREG_WITH_AMT;
    private BigDecimal NET_PAYABLE;

    private BigDecimal cmb_code;
    private Date cmb_date;
    private Date cmb_date_death_accident;
    private Date cmb_date_claim_reported;
    private String pol_policy_no;
    private String prp_surname;
    private String mem_surname;
    private String cmb_booked_by;
    private String cmb_processed;

    // Claim booking table
    private int CMB_DEATH_DISABILITY_AGE;
    private Date CMB_DATE;
    private Date CMB_DATE_DEATH_ACCIDENT;
    private Date CMB_DATE_CLAIM_REPORTED;
    private String CMB_BOOKED_BY;
    private String CMB_EXGRATIA;
    private String CMB_DEATH_LOCATION;
    private String CMB_EXGRATIA_REMARKS;


    //Cover type table
    private BigDecimal CBVT_SA;
    private BigDecimal CBVT_RESERVE_AMT;
    private BigDecimal CBVT_EARNINGS;
    private BigDecimal CBVT_MULT_EARNINGS_PRD;
    private String CBVT_ACCELERATOR;
    private BigDecimal CBVT_ORIGINAL_LOAN_AMT;
    private BigDecimal CBVT_ORIG_LOAN_REPAYMENT_PRD;
    private BigDecimal CBVT_SAVING_AMT;

    private boolean bookCoverCheck;

    private BigDecimal CBVT_CODE;
    
    private BigDecimal CMB_REINSURANCE_SHARE;
    private BigDecimal CMB_COINSURANCE_SHARE;
    private BigDecimal CMB_RETENTION_SHARE;
    private BigDecimal CMB_TOT_REINSURANCE_AMT;
    private BigDecimal CMB_TOT_COINSURANCE_AMT;
    private BigDecimal CMB_RETENTION_AMT;
    private BigDecimal CMB_RESERVE_AMT;
    ...
    public void setGPW_CODE(BigDecimal GPW_CODE) {
        this.GPW_CODE = GPW_CODE;
    }

    public BigDecimal getGPW_CODE() {
        return GPW_CODE;
    }

    public void setGPW_EMPYR_BAL_BF(BigDecimal GPW_EMPYR_BAL_BF) {
        this.GPW_EMPYR_BAL_BF = GPW_EMPYR_BAL_BF;
    }

    public BigDecimal getGPW_EMPYR_BAL_BF() {
        return GPW_EMPYR_BAL_BF;
    }

    public void setGPW_EMPYR_AMT(BigDecimal GPW_EMPYR_AMT) {
        this.GPW_EMPYR_AMT = GPW_EMPYR_AMT;
    }

    public BigDecimal getGPW_EMPYR_AMT() {
        return GPW_EMPYR_AMT;
    }

    public void setGPW_EMPYR_INT(BigDecimal GPW_EMPYR_INT) {
        this.GPW_EMPYR_INT = GPW_EMPYR_INT;
    }

    public BigDecimal getGPW_EMPYR_INT() {
        return GPW_EMPYR_INT;
    }

    public void setGPW_EMPYR_CF(BigDecimal GPW_EMPYR_CF) {
        this.GPW_EMPYR_CF = GPW_EMPYR_CF;
    }

    public BigDecimal getGPW_EMPYR_CF() {
        return GPW_EMPYR_CF;
    }

    public void setGPW_EMPYR_WITHDRAWABLE_AMT(BigDecimal GPW_EMPYR_WITHDRAWABLE_AMT) {
        this.GPW_EMPYR_WITHDRAWABLE_AMT = GPW_EMPYR_WITHDRAWABLE_AMT;
    }

    public BigDecimal getGPW_EMPYR_WITHDRAWABLE_AMT() {
        return GPW_EMPYR_WITHDRAWABLE_AMT;
    }

    public void setGPW_EMPYE_BAL_BF(BigDecimal GPW_EMPYE_BAL_BF) {
        this.GPW_EMPYE_BAL_BF = GPW_EMPYE_BAL_BF;
    }

    public BigDecimal getGPW_EMPYE_BAL_BF() {
        return GPW_EMPYE_BAL_BF;
    }

    public void setGPW_EMPYE_AMT(BigDecimal GPW_EMPYE_AMT) {
        this.GPW_EMPYE_AMT = GPW_EMPYE_AMT;
    }

    public BigDecimal getGPW_EMPYE_AMT() {
        return GPW_EMPYE_AMT;
    }

    public void setGPW_EMPYE_INT(BigDecimal GPW_EMPYE_INT) {
        this.GPW_EMPYE_INT = GPW_EMPYE_INT;
    }

    public BigDecimal getGPW_EMPYE_INT() {
        return GPW_EMPYE_INT;
    }

    public void setGPW_EMPYE_CF(BigDecimal GPW_EMPYE_CF) {
        this.GPW_EMPYE_CF = GPW_EMPYE_CF;
    }

    public BigDecimal getGPW_EMPYE_CF() {
        return GPW_EMPYE_CF;
    }

    public void setGPW_EMPYE_WITHDRAWABLE_AMT(BigDecimal GPW_EMPYE_WITHDRAWABLE_AMT) {
        this.GPW_EMPYE_WITHDRAWABLE_AMT = GPW_EMPYE_WITHDRAWABLE_AMT;
    }

    public BigDecimal getGPW_EMPYE_WITHDRAWABLE_AMT() {
        return GPW_EMPYE_WITHDRAWABLE_AMT;
    }

    public void setTOTAL_BAL_BF(BigDecimal TOTAL_BAL_BF) {
        this.TOTAL_BAL_BF = TOTAL_BAL_BF;
    }

    public BigDecimal getTOTAL_BAL_BF() {
        return TOTAL_BAL_BF;
    }
    ...
    public void setTOTAL_INT(BigDecimal TOTAL_INT) {
        this.TOTAL_INT = TOTAL_INT;
    }

    public BigDecimal getTOTAL_INT() {
        return TOTAL_INT;
    }

    public void setTOTAL_BAL_CF(BigDecimal TOTAL_BAL_CF) {
        this.TOTAL_BAL_CF = TOTAL_BAL_CF;
    }

    public BigDecimal getTOTAL_BAL_CF() {
        return TOTAL_BAL_CF;
    }

    public void setTOTAL_WITHDRAWABLE_AMT(BigDecimal TOTAL_WITHDRAWABLE_AMT) {
        this.TOTAL_WITHDRAWABLE_AMT = TOTAL_WITHDRAWABLE_AMT;
    }

    public BigDecimal getTOTAL_WITHDRAWABLE_AMT() {
        return TOTAL_WITHDRAWABLE_AMT;
    }

    public void setGPW_WITH_APPLIED_ON(String GPW_WITH_APPLIED_ON) {
        this.GPW_WITH_APPLIED_ON = GPW_WITH_APPLIED_ON;
    }

    public String getGPW_WITH_APPLIED_ON() {
        return GPW_WITH_APPLIED_ON;
    }

    public void setGPW_TAX_EXEMP_AMT(BigDecimal GPW_TAX_EXEMP_AMT) {
        this.GPW_TAX_EXEMP_AMT = GPW_TAX_EXEMP_AMT;
    }

    public BigDecimal getGPW_TAX_EXEMP_AMT() {
        return GPW_TAX_EXEMP_AMT;
    }

    public void setGPW_AMT_APPLIED(BigDecimal GPW_AMT_APPLIED) {
        this.GPW_AMT_APPLIED = GPW_AMT_APPLIED;
    }

    public BigDecimal getGPW_AMT_APPLIED() {
        return GPW_AMT_APPLIED;
    }

    public void setGPW_YRS_OF_SERV(BigDecimal GPW_YRS_OF_SERV) {
        this.GPW_YRS_OF_SERV = GPW_YRS_OF_SERV;
    }

    public BigDecimal getGPW_YRS_OF_SERV() {
        return GPW_YRS_OF_SERV;
    }

    public void setGPW_TAX_AMOUNT(BigDecimal GPW_TAX_AMOUNT) {
        this.GPW_TAX_AMOUNT = GPW_TAX_AMOUNT;
    }

    public BigDecimal getGPW_TAX_AMOUNT() {
        return GPW_TAX_AMOUNT;
    }

    public void setGPW_OVERRIDE_TAX_AMT(BigDecimal GPW_OVERRIDE_TAX_AMT) {
        this.GPW_OVERRIDE_TAX_AMT = GPW_OVERRIDE_TAX_AMT;
    }

    public BigDecimal getGPW_OVERRIDE_TAX_AMT() {
        return GPW_OVERRIDE_TAX_AMT;
    }

    public void setGPW_EMPYE_REG_WITH_AMT(BigDecimal GPW_EMPYE_REG_WITH_AMT) {
        this.GPW_EMPYE_REG_WITH_AMT = GPW_EMPYE_REG_WITH_AMT;
    }

    public BigDecimal getGPW_EMPYE_REG_WITH_AMT() {
        return GPW_EMPYE_REG_WITH_AMT;
    }

    public void setGPW_EMPYE_UNREG_WITH_AMT(BigDecimal GPW_EMPYE_UNREG_WITH_AMT) {
        this.GPW_EMPYE_UNREG_WITH_AMT = GPW_EMPYE_UNREG_WITH_AMT;
    }

    public BigDecimal getGPW_EMPYE_UNREG_WITH_AMT() {
        return GPW_EMPYE_UNREG_WITH_AMT;
    }

    public void setGPW_EMPYR_REG_WITH_AMT(BigDecimal GPW_EMPYR_REG_WITH_AMT) {
        this.GPW_EMPYR_REG_WITH_AMT = GPW_EMPYR_REG_WITH_AMT;
    }

    public BigDecimal getGPW_EMPYR_REG_WITH_AMT() {
        return GPW_EMPYR_REG_WITH_AMT;
    }

    public void setGPW_EMPYR_UNREG_WITH_AMT(BigDecimal GPW_EMPYR_UNREG_WITH_AMT) {
        this.GPW_EMPYR_UNREG_WITH_AMT = GPW_EMPYR_UNREG_WITH_AMT;
    }

    public BigDecimal getGPW_EMPYR_UNREG_WITH_AMT() {
        return GPW_EMPYR_UNREG_WITH_AMT;
    }
    ...
    public void setCmb_code(BigDecimal cmb_code) {
        this.cmb_code = cmb_code;
    }

    public BigDecimal getCmb_code() {
        return cmb_code;
    }
    ...
    public void setCmb_date_death_accident(Date cmb_date_death_accident) {
        this.cmb_date_death_accident = cmb_date_death_accident;
    }

    public Date getCmb_date_death_accident() {
        return cmb_date_death_accident;
    }

    public void setCmb_date_claim_reported(Date cmb_date_claim_reported) {
        this.cmb_date_claim_reported = cmb_date_claim_reported;
    }

    public Date getCmb_date_claim_reported() {
        return cmb_date_claim_reported;
    }
    ...
    public void setPrp_surname(String prp_surname) {
        this.prp_surname = prp_surname;
    }

    public String getPrp_surname() {
        return prp_surname;
    }
    ...
    public void setCmb_booked_by(String cmb_booked_by) {
        this.cmb_booked_by = cmb_booked_by;
    }

    public String getCmb_booked_by() {
        return cmb_booked_by;
    }

    public void setCmb_processed(String cmb_processed) {
        this.cmb_processed = cmb_processed;
    }

    public String getCmb_processed() {
        return cmb_processed;
    }

    public void setCMB_DEATH_DISABILITY_AGE(int CMB_DEATH_DISABILITY_AGE) {
        this.CMB_DEATH_DISABILITY_AGE = CMB_DEATH_DISABILITY_AGE;
    }

    public int getCMB_DEATH_DISABILITY_AGE() {
        return CMB_DEATH_DISABILITY_AGE;
    }
    ...
    public void setCMB_EXGRATIA(String CMB_EXGRATIA) {
        this.CMB_EXGRATIA = CMB_EXGRATIA;
    }

    public String getCMB_EXGRATIA() {
        return CMB_EXGRATIA;
    }

    public void setCMB_DEATH_LOCATION(String CMB_DEATH_LOCATION) {
        this.CMB_DEATH_LOCATION = CMB_DEATH_LOCATION;
    }

    public String getCMB_DEATH_LOCATION() {
        return CMB_DEATH_LOCATION;
    }

    public void setCMB_EXGRATIA_REMARKS(String CMB_EXGRATIA_REMARKS) {
        this.CMB_EXGRATIA_REMARKS = CMB_EXGRATIA_REMARKS;
    }

    public String getCMB_EXGRATIA_REMARKS() {
        return CMB_EXGRATIA_REMARKS;
    }

    public void setCBVT_SA(BigDecimal CBVT_SA) {
        this.CBVT_SA = CBVT_SA;
    }

    public BigDecimal getCBVT_SA() {
        return CBVT_SA;
    }

    public void setCBVT_RESERVE_AMT(BigDecimal CBVT_RESERVE_AMT) {
        this.CBVT_RESERVE_AMT = CBVT_RESERVE_AMT;
    }

    public BigDecimal getCBVT_RESERVE_AMT() {
        return CBVT_RESERVE_AMT;
    }

    public void setCBVT_EARNINGS(BigDecimal CBVT_EARNINGS) {
        this.CBVT_EARNINGS = CBVT_EARNINGS;
    }

    public BigDecimal getCBVT_EARNINGS() {
        return CBVT_EARNINGS;
    }

    public void setCBVT_MULT_EARNINGS_PRD(BigDecimal CBVT_MULT_EARNINGS_PRD) {
        this.CBVT_MULT_EARNINGS_PRD = CBVT_MULT_EARNINGS_PRD;
    }

    public BigDecimal getCBVT_MULT_EARNINGS_PRD() {
        return CBVT_MULT_EARNINGS_PRD;
    }

    public void setCBVT_ACCELERATOR(String CBVT_ACCELERATOR) {
        this.CBVT_ACCELERATOR = CBVT_ACCELERATOR;
    }

    public String getCBVT_ACCELERATOR() {
        return CBVT_ACCELERATOR;
    }

    public void setCBVT_ORIGINAL_LOAN_AMT(BigDecimal CBVT_ORIGINAL_LOAN_AMT) {
        this.CBVT_ORIGINAL_LOAN_AMT = CBVT_ORIGINAL_LOAN_AMT;
    }

    public BigDecimal getCBVT_ORIGINAL_LOAN_AMT() {
        return CBVT_ORIGINAL_LOAN_AMT;
    }

    public void setCBVT_ORIG_LOAN_REPAYMENT_PRD(BigDecimal CBVT_ORIG_LOAN_REPAYMENT_PRD) {
        this.CBVT_ORIG_LOAN_REPAYMENT_PRD = CBVT_ORIG_LOAN_REPAYMENT_PRD;
    }

    public BigDecimal getCBVT_ORIG_LOAN_REPAYMENT_PRD() {
        return CBVT_ORIG_LOAN_REPAYMENT_PRD;
    }

    public void setCBVT_SAVING_AMT(BigDecimal CBVT_SAVING_AMT) {
        this.CBVT_SAVING_AMT = CBVT_SAVING_AMT;
    }

    public BigDecimal getCBVT_SAVING_AMT() {
        return CBVT_SAVING_AMT;
    }

    public void setBookCoverCheck(boolean bookCoverCheck) {
        this.bookCoverCheck = bookCoverCheck;
    }

    public boolean isBookCoverCheck() {
        return bookCoverCheck;
    }

    public void setCBVT_CODE(BigDecimal CBVT_CODE) {
        this.CBVT_CODE = CBVT_CODE;
    }

    public BigDecimal getCBVT_CODE() {
        return CBVT_CODE;
    }

    public void setCMB_REINSURANCE_SHARE(BigDecimal CMB_REINSURANCE_SHARE) {
        this.CMB_REINSURANCE_SHARE = CMB_REINSURANCE_SHARE;
    }

    public BigDecimal getCMB_REINSURANCE_SHARE() {
        return CMB_REINSURANCE_SHARE;
    }

    public void setCMB_COINSURANCE_SHARE(BigDecimal CMB_COINSURANCE_SHARE) {
        this.CMB_COINSURANCE_SHARE = CMB_COINSURANCE_SHARE;
    }

    public BigDecimal getCMB_COINSURANCE_SHARE() {
        return CMB_COINSURANCE_SHARE;
    }

    public void setCMB_RETENTION_SHARE(BigDecimal CMB_RETENTION_SHARE) {
        this.CMB_RETENTION_SHARE = CMB_RETENTION_SHARE;
    }

    public BigDecimal getCMB_RETENTION_SHARE() {
        return CMB_RETENTION_SHARE;
    }

    public void setCMB_TOT_REINSURANCE_AMT(BigDecimal CMB_TOT_REINSURANCE_AMT) {
        this.CMB_TOT_REINSURANCE_AMT = CMB_TOT_REINSURANCE_AMT;
    }

    public BigDecimal getCMB_TOT_REINSURANCE_AMT() {
        return CMB_TOT_REINSURANCE_AMT;
    }

    public void setCMB_TOT_COINSURANCE_AMT(BigDecimal CMB_TOT_COINSURANCE_AMT) {
        this.CMB_TOT_COINSURANCE_AMT = CMB_TOT_COINSURANCE_AMT;
    }

    public BigDecimal getCMB_TOT_COINSURANCE_AMT() {
        return CMB_TOT_COINSURANCE_AMT;
    }

    public void setCMB_RETENTION_AMT(BigDecimal CMB_RETENTION_AMT) {
        this.CMB_RETENTION_AMT = CMB_RETENTION_AMT;
    }

    public BigDecimal getCMB_RETENTION_AMT() {
        return CMB_RETENTION_AMT;
    }

    public void setCMB_RESERVE_AMT(BigDecimal CMB_RESERVE_AMT) {
        this.CMB_RESERVE_AMT = CMB_RESERVE_AMT;
    }

    public BigDecimal getCMB_RESERVE_AMT() {
        return CMB_RESERVE_AMT;
    }
    ...
    public void setRiGlAccount(String riGlAccount) {
        this.riGlAccount = riGlAccount;
    }

    public String getRiGlAccount() {
        return riGlAccount;
    }
