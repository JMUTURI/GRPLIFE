 ...
 */
  ...
  public Session Authentification() {
      ...
      Connection ecmConn;
      ecmConn = datahandler.getDatabaseConn();
           
      DBConnector ecmDatahandler = null;
      ecmDatahandler = new DBConnector();
      //Connection ecmConn = null;
      ecmConn = ecmDatahandler.getDatabaseConn();
      ...
      try {
          ...
          while (rs.next()) {
              ...
              proxyUsername = rs.getString(8);
              proxyPassWord = rs.getString(9);
          ...
          ecmSession = this.createSession(username, passWord,
                                          proxyUsername,proxyPassWord,url);
        ...
        GlobalCC.errorValueNotEntered("Please Check alfresco connection : Can't Connect to alfresco!!");
          ...
          // TODO: Add catch code
          e.printStackTrace();
        GlobalCC.errorValueNotEntered("Error in connection : " + e.getMessage());
      }
 ...
 */
    ...
    public File reportFile(BigDecimal rptCode) {
        ...
        try {
            ...
            //ecmFile = xmlPublisher.FileProcessorEngine(reportFormat, templateFile,
 ...
 */
   ...
   */
    ...
    public Session createSession(String user, String password, String proxyUser,
                                 String proxyPassword, String url) {
      SessionFactory sessionFactory = SessionFactoryImpl.newInstance();
      Map<String, String> parameter = new HashMap<String, String>();
      parameter.put(SessionParameter.USER, user);
      parameter.put(SessionParameter.PASSWORD, password);
      parameter.put(SessionParameter.PROXY_USER, proxyUser);
      parameter.put(SessionParameter.PROXY_PASSWORD, proxyPassword);
