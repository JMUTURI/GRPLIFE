...
public class medicalsDAO extends LOVCC {
    ...
    public List<medical> FindMedicalGroups() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.FindmedicalsGroup(?,?,?,?);end;";
    ...
    public List<medical> FindMedQuestionnaires() {
        ...
        try {
            String polMeds =
                "begin LMS_WEB_CURSOR_GRP.Get_Medical_Questionnaires(?);end;";
    ...
    public List<medical> FindExistingPoliciesView() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.FindExistingPolVw(?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setBigDecimal(2,
                              (BigDecimal)session.getAttribute("PolmMemCode"));
    ...
    public List<medical> FindClientMedicals() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.FindclientMedicals(?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setBigDecimal(2,
                              (BigDecimal)session.getAttribute("PolmMemCode"));
    ...
    public List<medical> FindMedicalPolicies() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.find_medical_policies(?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
    ...
    public List<medical> findMedTest() {
        ...
        try {
            ...
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setString(2,
                          (String)session.getAttribute("CMICode")); //cmi code
            cst.execute();
    ...
    public List<medical> FindPolicyMemberMedicals() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.findpol_mem_medicals(?,?,?,?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setBigDecimal(2,
                              (BigDecimal)session.getAttribute("policyCode"));
    ...
    public List<medical> FindFacilitatorsView() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.FindmedicalFacVw(?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setString(2,
                          (String)session.getAttribute("CMICode")); //cmi code
    ...
    public List<medical> FindUWDecisionView() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.get_uw_decisions(?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setBigDecimal(2,
                              (BigDecimal)session.getAttribute("policyCode")); //cmi code
    ...
    public List<medical> FindMemberUWDecisionView() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.get_mem_uw_decisions(?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setBigDecimal(2,
                              (BigDecimal)session.getAttribute("PolmMemCode")); //Member code
    ...
    public List<medical> FindMedicalPaymentsQuery() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.medicalPaymentsQuery(?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setString(2,
                          (String)session.getAttribute("PaymentsFlag")); //cmi code
    ...
    public List<medical> FindMedicalPayments() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.Findmedpayments(?,?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setBigDecimal(2,
                              (BigDecimal)session.getAttribute("MedPolicy"));
            cst.setBigDecimal(3,
            ...
            while (rst.next()) {
                ...
                myMeds.setMP_CML_INVCE_NO(rst.getString(14));
                myMeds.setMP_CML_INVCE_DATE(rst.getDate(15));
    ...
    public List<medical> FindFacilitatorPayments() {
        ...
        try {
            String polQuery =
                "begin LMS_WEB_CURSOR_GRP.findfacilitatorpayments(?,?);end;";
            cst = conn.prepareCall(polQuery);
            cst.registerOutParameter(1, OracleTypes.CURSOR);
            cst.setBigDecimal(2,
                              (BigDecimal)session.getAttribute("MedTransNo"));
            ...
            while (rst.next()) {
                ...
                myMeds.setFPMT_AUTHORISED_DATE(rst.getString(9));
                myMeds.setFPMT_PYMT_VCHR_NO(rst.getString(10));
                myMeds.setFPMT_CHQ_DATE(rst.getString(11));
                myMeds.setFPMT_CHQ_NO(rst.getString(12));
                myMeds.setFPMT_WTHX_RATE(rst.getBigDecimal(13));
                myMeds.setFPMT_WTHX_AMT(rst.getBigDecimal(14));
                MedList.add(myMeds);
    ...
    public List<medical> FindAuthorizedFacilitatorPayments() {
        DBConnector myConn = new DBConnector();
        Connection conn = myConn.getDatabaseConn();
        CallableStatement cst = null;
